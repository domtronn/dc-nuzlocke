...
<style>
  ...
  nav {
    ...
    bottom: 0;
    z-index: 5000;
    @apply container mx-auto pt-2 md:mb-2 bg-black sm:bg-white text-white sm:text-black;
  }
  ...
  a.link, div.link { @apply inline-flex items-center gap-x-1 border-black transition p-2 px-3 md:p-4 text-sm md:text-base; }
